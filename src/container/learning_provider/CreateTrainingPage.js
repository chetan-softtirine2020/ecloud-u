                  ...
                  <div className="row">
                    <div className="col-lg-6 mb-2">
                      <div className="form-group">
                        ...
                        <DatePicker
                          className="form-control"
                          selected={traning.start_date}
                          minDate={new Date()}
                          onChange={(date) =>
                            setTraining({ ...traning, start_date: date })
                          }
                          showTimeSelect
                          dateFormat="Pp"
                        />
                        <span className="error-msg">
                          {state.errors ? state.errors.start_date : ""}
                        </span>
                      </div>
                    </div>
                    <div className="col-lg-6 mb-2">
                      <div className="form-group">
                        ...
                        <DatePicker
                          className="form-control"
                          selected={traning.end_date}
                          minDate={traning.start_date}
                          onChange={(date) =>
                            setTraining({ ...traning, end_date: date })
                          }
                          showTimeSelect
                          dateFormat="Pp"
                        />
                        <span className="error-msg">
                          {state.errors ? state.errors.end_date : ""}
                        </span>
                      </div>
                    </div>
                  </div>
